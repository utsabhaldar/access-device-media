...
import 'package:third_app/Constants/constant.dart';
...
class GetStatusProvider extends ChangeNotifier {
  ...
  void getStatus(String ext) async {
    ...
    if (status.isGranted) {
      final directory = Directory(AppConstants.WHATSAPP_PATH_IMAGE);
      final directory1 = Directory(AppConstants.WHATSAPP_PATH_VIDEO);
      ...
      if (directory1.existsSync()) {
        final items = directory1.listSync();
